...
/*----- instance variables */
    ...
    */
    public GreedyInformationGainDecisionTree(ArrayList<Example> exs, 
        ArrayList<HashSet<String>> masterAttributes, HashSet<String> attributes, HashSet<String> outputClasses, boolean ig) {
...
/*----- implemented methods */
    ...
    private Node<String, String> recursiveTreeBuilder(
        ...
        } else { //split examples on most important attribute normally
